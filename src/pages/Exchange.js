...
function Exchange(props) {
  ...
  const quateSwap = async (e) => {
    ...
    try {
      ...
      var fromAddressContract = new web3Obj.eth.Contract(WBNB, fromAddress.address);
      var fromAddressDecimals = await fromAddressContract.methods.decimals().call();
      var allowance = await fromAddressContract.methods.allowance(account, Router).call();
      ...
      if (fromAddress.address === WETH) {
        var amountsOut = await contract.methods.getAmountsOut(`${amountIn}`, [WETH, toAddress.address]).call();

        var outputAmount = amountsOut[1] / 10 ** toAddressDecimals;
      } else if (toAddress.address === WETH) {
        var amountsOut = await contract.methods.getAmountsOut(`${amountIn}`, [fromAddress.address, WETH]).call();
        var outputAmount = amountsOut[1] / 10 ** toAddressDecimals;
      } else {
        var amountsOut = await contract.methods.getAmountsOut(`${amountIn}`, [fromAddress.address, WETH, toAddress.address]).call();
            ...
            <div className="checkout-form-centre">
              <div className="checkout-login-step">
                <div className="product-body">
                        ...
                        <div className="modal-body-1">
                          <div className="swaps-liquidation">
                            ...
                            <ul style={{ marginBottom: "15px" }}>
                              ...
                              <li>
                                <input type="number" className="form-control" placeholder="2%" min={1} max={49} onChange={(e) => setSlippage(e.target.value)} />
                              </li>
                            </ul>
                            <div className="details">
                              ...
                              <input type="text" className="form-control" placeholder="20" onChange={(e) => setDeadLine(e.target.value)} />
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <a href="">
                    <h6 style={{ fontSize: "20px" }}>Trade tokens in an instant</h6>
                  </a>
                </div>
                        ...
                        <div className="modal-dialog">
                          <div className="modal-content">
                            <div className="modal-header">
                              ...
                              <button type="button" onClick={onModalToggled} className="close" data-dismiss="modal">
                                &times;
                              </button>
                            </div>
                                ...
                                <div className="select2-list bg-light w-100 rounded-bottom">
                                  <div className="container mt-3">
                                    <input
                                      ...
                                      onChange={(e) => setTokenInfo(tokenList(e.target.value))}
                                    />
                                    {tokenInfo.map((row, index) => (
                                      <div
                                        ...
                                        data-value="1"
                                        onClick={(e) => {
                                          if (toAddress && toAddress.address === row.address) {
                                            settoToken("");
                                            setToAddress("");
                                          }
                                          setFromAddress(row);
                ...
                <div className="add-liquidity">
                  ...
                  <div className="form-row">
                    <div className="wizard-form-input col-md-6 col-sm-12">
                      <input type="text" className="form-control" placeholder="0.0" disabled={true} value={parseFloat(toAmount).toFixed(9)} />
                    </div>
                    <div className="wizard-form-input col-md-6 col-sm-12">
                      ...
                      >
                        <div className="modal-dialog">
                          <div className="modal-content">
                            <div className="modal-header">
                              <h4 className="modal-title">Select a Token</h4>
                              <button type="button" onClick={onModalToggled2} className="close" data-dismiss="modal">
                                &times;
                              </button>
                            </div>
                                  ...
                                  <div className="container mt-3">
                                    ...
                                    {tokenInfo.map((row, index) => (
                                      <div
                                        ...
                                        data-value="1"
                                        onClick={(e) => {
                                          if (fromAddress && fromAddress.address === row.address) {
                                            setFromToken("");
                                            setFromAddress("");
                                          }
                                          setToAddress(row);
                ...
                {isConnected ? (
                  chain.chain.id === 56 ? (
                    !swapActive ? (
                      ...
                      <div>
                        <button disabled={loading} onClick={() => approve()} className="btn btn-danger">
                          {loading ? "Please wait, Loading.." : "Enable"}
                        </button>
                      </div>
                    ) : (
                      <div>
                        <button disabled={loading} onClick={() => swap()} className="btn btn-danger">
                  ...
                  <a className="btn btn-danger" style={{ background: "none", border: "none", cursor: "initial" }}>
                    <Web3Button />
                  </a>
                )}
